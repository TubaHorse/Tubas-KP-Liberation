#include "..\defines.hpp"
/*
    File: fn_build_perms_createActiveText.sqf
    ...
    Description:
        Crate active text on build permission display

    Parameter(s):
        _display - build permissions display [DISPLAY]
...
_control ctrlSetPosition [0.054 * _column * safeZoneW, (_idx * 0.025) * safezoneH, 0.072 * safeZoneW, 0.025  * safezoneH];
...
private _permsData = _data param [1, [false,false,false,false,false,false,false,false]];
...
_control ctrlAddEventHandler ["ButtonClick", {
    ...
    private _permissions = _data param [1, [false,false,false,false,false,false,false,false]];
    ...
    if (_uid != "Default") then {
        ...
        private _defaultPerms = _defaultData param [1, [false,false,false,false,false,false,false,false]];
