...
class LiberationGeneralPermsRsc {
    idd = IDD_GENERAL_PERMS_MENU;
    movingEnable = false;
    onLoad = "[_this # 0] call KPLIB_fnc_general_perms_loadMenu";
    onUnload = "[_this # 0] call KPLIB_fnc_general_perms_unloadMenu";
    ...
    class Header: StdHeader {
        ...
        text = $STR_GENERAL_PERMISSIONS_TITLE;
    };
