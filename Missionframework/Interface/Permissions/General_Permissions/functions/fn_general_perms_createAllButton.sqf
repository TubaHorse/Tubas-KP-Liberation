#include "..\defines.hpp"
/*
    File: fn_general_perms_createAllButton.sqf
...
_control ctrlAddEventHandler ["ButtonClick", {
    ...
    KPLIB_temp_permissions set [_uid, [_name, [true,true,true,true,true,true]]];
    ...
    if (_uid == "Default") then {
        {
            ...
            KPLIB_temp_permissions set [_key, [_name, [true,true,true,true,true,true]]];
