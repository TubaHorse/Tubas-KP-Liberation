#include "..\defines.hpp"
/*
    File: fn_general_perms_createNoneButton.sqf
    ...
    Description:
        Create "NONE" button to the row

    Parameter(s):
        _display - general permissions menu display [DISPLAY]
        _controlGrp - general permission control group [CONTROL]
...
_control = _display ctrlCreate ["RscButton", ((10 * _idx) + 111) + 8, _controlGrp];
...
_control ctrlAddEventHandler ["ButtonClick", {
    ...
    KPLIB_temp_permissions set [_uid, [_name, [false,false,false,false,false,false]]];
    ...
    // Update colors
    {
        _x ctrlSetTextColor COLOR_DENIED;
        _x ctrlSetActiveColor COLOR_DENIED;
    ...
    if (_uid == "Default") then {
        {
            ...
            KPLIB_temp_permissions set [_key, [_name, [false,false,false,false,false,false]]];
