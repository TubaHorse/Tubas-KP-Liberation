...
if (_vehicle isKindOf "Helicopter") then {
    ...
    private _wp1 = _vehicleGroup addWaypoint [_attackPos, 25];
    _wp1 setWaypointType "SAD";
    ...
    private _idPFH = [{
        ...
        _args params ["_attackPos", "_helicopter", "_heliGroup"];
        ...
        private _wp1 = _heliGroup addWaypoint [_attackPos, 25];
        _wp1 setWaypointType "SAD";
        _wp1 setWaypointCompletionRadius 100;
        
        private _bluforEntities = [_attackPos, 250, KPLIB_side_player] call KPLIB_fnc_getNearbyEntities;
    ...
    }, 15, [_attackPos, _vehicle, _vehicleGroup]] call CBA_fnc_addPerFrameHandler;
