...
if (KPLIB_civrep_debug > 0) then {[format ["ace_action called on: %1", KPLIB_debugSource], "CIVREP"] remoteExecCall ["KPLIB_fnc_log", 2];};
...
_civ addAction [
    "<t color='#FF0000'>" + localize "STR_CR_ACE_ACTION" + "</t>",
    {
        ...
        if !(_items isEqualTo []) then {
            ...
            [localize "STR_CR_ACE_ACTION_FAIL", true, 3] call KPLIB_fnc_hint;
        };
    },
    nil,
    1.5,
