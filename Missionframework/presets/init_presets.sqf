...
switch (KPLIB_presetPlayer) do {
    ...
    case 31: {[] call compile preprocessFileLineNumbers "Presets\Players\cup_aaf_deserters.sqf";};
    default  {};
};
...
switch (KPLIB_presetEnemy) do {
    ...
    case 21: {[] call compile preprocessFileLineNumbers "Presets\Enemies\cup_aaf.sqf";};
    default  {};
};
...
switch (KPLIB_presetResistance) do {
    ...
    case  9: {[] call compile preprocessFileLineNumbers "Presets\Resistance\cup_fia.sqf";};
...
switch (KPLIB_presetCivilians) do {
    ...
    case  8: {[] call compile preprocessFileLineNumbers "Presets\Civilians\cup_acw.sqf";};
