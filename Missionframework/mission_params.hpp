class Params {
    ...
    #include "Presets\mission_params.hpp"
    class Spacer0 {
        title = "";
        values[] = {""};
        texts[] = {""};
    ...
    class VictoryCondition {
        ...
        texts[] = {$STR_PARAMS_VICTORYCONDITION_0, $STR_PARAMS_VICTORYCONDITION_1, $STR_PARAMS_VICTORYCONDITION_2, $STR_PARAMS_VICTORYCONDITION_3, $STR_PARAMS_VICTORYCONDITION_4, $STR_PARAMS_VICTORYCONDITION_5, $STR_PARAMS_VICTORYCONDITION_6, $STR_PARAMS_VICTORYCONDITION_7, $STR_PARAMS_VICTORYCONDITION_8};
        default = 1;
    };
    #include "Extensions\mission_params.hpp"
    class Spacer1 {
        title = "";
        values[] = {""};
        texts[] = {""};
    ...
    class airActiveSector {
        title = $STR_PARAM_AIR_ACTIVESECTOR;
        values[] = {1, 0};
        texts[] = {$STR_PARAMS_ENABLED, $STR_PARAMS_DISABLED};
        default = 0;
    };
