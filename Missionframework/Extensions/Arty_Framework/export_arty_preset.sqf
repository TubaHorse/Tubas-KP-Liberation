/*
	...
	This script is not perfect and it's a litle messy, but it should work with all modded artillery.
	It's ideal for MORTAR and SPAs, but it can return information about ROCKET BASED ARTILLERY as well.
	...
	[cursorObject] execVM export_arty_preset.sqf
	...
	For now, it works fine for SPA and not so much for rocket based artillery. For these ones, use getArtilleryAmmo directly instead, because generally it's just one type of magazine.
