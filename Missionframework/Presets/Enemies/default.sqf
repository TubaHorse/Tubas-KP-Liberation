...
KPLIB_o_jetPilot = "O_helipilot_F";                                     // Helicopter Pilot
KPLIB_o_heliPilot = "O_Pilot_F";                                        // Jet Pilot
...
// Static AA
KPLIB_o_statics_AA = [
    "O_static_AA_F"                                                     // Mini-Spike Launcher (AT)
];

// Enemy SAM radars only (with active radar component!)
KPLIB_o_SAM_radars = [
...
// Enemy SAM SHORAD (used to defeat incoming missiles to SAM Sites, ONLY AA WITH MACHINEGUNS!)
KPLIB_o_SAM_SHORAD = [
    "O_APC_Tracked_02_AA_F"                                             // ZSU-39 Tigris
];
